...
require 'musicality/notation/model/slur_marks'
...
require 'musicality/notation/model/instrument'
require 'musicality/notation/model/instruments'
...
require 'musicality/notation/parsing/slur_mark_parsing'
require 'musicality/notation/parsing/note_parsing'
require 'musicality/notation/parsing/note_nodes'
